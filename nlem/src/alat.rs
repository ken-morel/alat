        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/alat.AlatService/GetDeviceInfo",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("alat.AlatService", "GetDeviceInfo"));
...
pub mod alat_service_server {
    ...
    pub const SERVICE_NAME: &str = "alat.AlatService";
...
pub mod pair_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/alat.PairService/RequestPair",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("alat.PairService", "RequestPair"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
pub mod pair_service_server {
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "alat.PairService";
