...
type SysInfo struct {
	...
	MemUsed         int32                  `protobuf:"varint,5,opt,name=memUsed,proto3" json:"memUsed,omitempty"`
	DiskTotal       int64                  `protobuf:"varint,6,opt,name=diskTotal,proto3" json:"diskTotal,omitempty"`
	DiskUsed        int64                  `protobuf:"varint,7,opt,name=diskUsed,proto3" json:"diskUsed,omitempty"`
	BatteryCharging bool                   `protobuf:"varint,8,opt,name=batteryCharging,proto3" json:"batteryCharging,omitempty"`
	BatteryPercent  float32                `protobuf:"fixed32,9,opt,name=batteryPercent,proto3" json:"batteryPercent,omitempty"`
	CpuUsage        float32                `protobuf:"fixed32,10,opt,name=cpuUsage,proto3" json:"cpuUsage,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *SysInfo) GetMemTotal() int32 {
	if x != nil {
		return x.MemTotal
	}
	return 0
...
func (x *SysInfo) GetMemUsed() int32 {
	if x != nil {
		return x.MemUsed
	}
	return 0
...
func (x *SysInfo) GetDiskTotal() int64 {
	if x != nil {
		return x.DiskTotal
	}
	return 0
...
func (x *SysInfo) GetDiskUsed() int64 {
	if x != nil {
		return x.DiskUsed
	}
	return 0
...
func (x *SysInfo) GetBatteryPercent() float32 {
	if x != nil {
...
func (x *SysInfo) GetCpuUsage() float32 {
	if x != nil {
		return x.CpuUsage
	}
	return 0
...
const file_pair_proto_rawDesc = "" +
	...
	"\bmemTotal\x18\x04 \x01(\x05R\bmemTotal\x12\x18\n" +
	"\amemUsed\x18\x05 \x01(\x05R\amemUsed\x12\x1c\n" +
	"\tdiskTotal\x18\x06 \x01(\x03R\tdiskTotal\x12\x1a\n" +
	"\bdiskUsed\x18\a \x01(\x03R\bdiskUsed\x12(\n" +
