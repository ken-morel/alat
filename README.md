...
> [!NOTE] This is generated by `qwen` cli free and I didn't really completely fix it yet. The project is nothing but starting, and I'm not that fast as a rust beginner, so I didn't spend time handwritting a readme just yet.
...
This software is licensed under a custom license that permits educational use, personal modification, and contributions, but explicitly prohibits commercial use without explicit written permission. For commercial licensing inquiries, contact: [engonken8@gmail.com](mailto:engonken8@gmail.com) or [me@engon.cm](mailto:me@engon.cm)
...
- **Alat Project**: <https://alat.engon.cm>
